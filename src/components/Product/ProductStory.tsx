  ...
  const clipPath = useTransform(
    ...
    return (
        <section className='product-story-section relative'>
            <div ref={sectionRef} className="relative lg:h-[800vh] h-auto max-lg:pt-50 max-lg:pb-60">
                <div className="text-image sticky top-0 lg:h-screen w-full lg:overflow-hidden">
                    <div className='container flex flex-col items-center justify-center h-full'>
                        <h2 className="font-heading lg:text-7xl! lg:leading-23! xl:text-8xl! xl:leading-25! md:text-6xl! md:leading-17! font-bold text-center xl:max-w-4xl max-w-xl flex flex-wrap justify-center z-10">
                            {isDesktop ? (
                        ...
                        <div className="lg:mt-10 mt-0 text-xl md:text-2xl text-center text-gray-600 z-10">
                            {isDesktop ? (
                                <>
                                ...
                                <RevealText tag="p" className="text-2xl leading-normal">
...
function StoryImage({ src, progress, range, side, align, targetTop }: {
    ...
    return (
        <motion.div
            ...
            className="text-with-img absolute w-full max-w-[30%] z-20 pointer-events-none max-lg:transform-none! max-[1025px]:top-[unset]! max-[1025px]:bottom-[150px] max-sm:bottom-[200px] max-lg:opacity-100!"
        >
            <Image
                src={src}
                alt="Product Story"
